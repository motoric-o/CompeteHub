<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="page-title">Edit Template Form</h2>
                <p class="text-sm text-muted-foreground mt-1">{{ $template->name }} — {{ $competition->name }}</p>
            </div>
                        ...
                        <form id="templateForm" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="name" name="name" type="text" class="block mt-1 w-full"
                                    value="{{ old('name', $template->name) }}" required autofocus placeholder="Contoh: Form Registrasi Web Dev" />
                            </div>
