        ...
        <div class="grid grid-cols-2">
            ...
            <div class="form-group" id="submission_mode_group">
                ...
                <select name="submission_mode" id="submission_mode" class="form-control">
                    <option value="captain_only" {{ old('submission_mode') == 'captain_only' ? 'selected' : '' }}>Hanya Ketua Tim</option>
                    <option value="all_members" {{ old('submission_mode') == 'all_members' ? 'selected' : '' }}>Semua Anggota Tim</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="category" id="category" class="form-control" required>
                    ...
                    <option value="Capture The Flag" {{ old('category') == 'Capture The Flag' ? 'selected' : '' }}>Capture The Flag (CTF)</option>
                    <option value="UI/UX Design" {{ old('category') == 'UI/UX Design' ? 'selected' : '' }}>UI/UX Design</option>
                    <option value="Competitive Programming" {{ old('category') == 'Competitive Programming' ? 'selected' : '' }}>Competitive Programming</option>
                    <option value="Other" {{ old('category') == 'Other' ? 'selected' : '' }}>Lainnya (Other)</option>
                </select>
            </div>
