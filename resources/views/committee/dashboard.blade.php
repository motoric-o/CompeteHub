            ...
            <div class="bg-white/90 backdrop-blur-sm overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100">
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <!-- Card 1 -->
                        <div class="group cursor-pointer bg-gradient-to-br from-indigo-50 to-white rounded-2xl p-6 border border-indigo-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-100">
                        ...
                        <!-- Card 2 -->
                        <div class="group cursor-pointer bg-gradient-to-br from-green-50 to-white rounded-2xl p-6 border border-green-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-green-100">
                        ...
                        <!-- Card 3 -->
                        <div class="group cursor-pointer bg-gradient-to-br from-yellow-50 to-white rounded-2xl p-6 border border-yellow-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-yellow-100">
