<x-app-layout>
    ...
    @php
        $latestCompetition = \App\Models\Competition::where('user_id', auth()->id())->latest()->first();
    @endphp
    ...
    <div class="py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a href="{{ $latestCompetition ? route('committee.form-templates.index', $latestCompetition) : route('committee.management.competitions.create') }}" class="card block group">
                <div class="flex items-center gap-4 mb-4">
            ...
            <a href="{{ $latestCompetition ? route('committee.registrations.index', $latestCompetition) : route('committee.management.competitions.create') }}" class="card block group">
                <div class="flex items-center gap-4 mb-4">
