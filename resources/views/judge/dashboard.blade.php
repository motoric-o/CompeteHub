            ...
            <div class="bg-white/90 backdrop-blur-sm overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100">
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <a href="{{ route('judge.competitions.index') }}" class="block group cursor-pointer bg-gradient-to-br from-purple-50 to-white rounded-2xl p-6 border border-purple-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-100">
                        ...
                        <a href="{{ route('judge.competitions.index') }}" class="block group cursor-pointer bg-gradient-to-br from-pink-50 to-white rounded-2xl p-6 border border-pink-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-100">
