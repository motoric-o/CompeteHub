...
class RegistrationDocumentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('registration_documents')->insert([
            ...
            ['registration_id' => $regAlpha, 'document_type' => 'Kartu Mahasiswa', 'file_path' => 'docs/alpha_ktm.pdf', 'status' => 'verified', 'uploaded_at' => now()],
            ['registration_id' => $regAlpha, 'document_type' => 'Proposal Ide', 'file_path' => 'docs/alpha_proposal.pdf', 'status' => 'verified', 'uploaded_at' => now()],
            ...
            ['registration_id' => $regBeta, 'document_type' => 'Kartu Mahasiswa', 'file_path' => 'docs/beta_ktm.pdf', 'status' => 'verified', 'uploaded_at' => now()],
            ['registration_id' => $regBeta, 'document_type' => 'Proposal Ide', 'file_path' => 'docs/beta_proposal.pdf', 'status' => 'verified', 'uploaded_at' => now()],
            // Budi — CP, verified
            ['registration_id' => $regBudi, 'document_type' => 'KTP', 'file_path' => 'docs/budi_ktp.pdf', 'status' => 'verified', 'uploaded_at' => now()],
            ['registration_id' => $regBudi, 'document_type' => 'Kartu Mahasiswa', 'file_path' => 'docs/budi_ktm.pdf', 'status' => 'verified', 'uploaded_at' => now()],
